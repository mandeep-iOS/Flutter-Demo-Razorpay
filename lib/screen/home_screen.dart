...
import "package:flutter_razorpay_demo/crud_operations/crud_operations.dart";
import "package:flutter_razorpay_demo/singletons/razorpay_singleton.dart";
import "package:flutter_razorpay_demo/widgets/grid_view_widget.dart";
import "package:flutter_razorpay_demo/widgets/list_view_widget.dart";
  ...
  Widget floatingActionButton() {
    return CRUDOperationsController().cartListFunction().isNotEmpty &&
        ...
        ? FloatingActionButton.extended(
            onPressed: () async {
              await RazorpaySingleton().makePayment(
                ...
                failureAcknowledgement: (String acknowledgement) {
                  showStatusAlert(
                    isSuccess: false,
                    acknowledgement: acknowledgement,
                  );
